      ...
      <nav className={containerClassName} style={style} aria-label="Main navigation">
        ...
        <button
          ...
          className={[
            ...
            'rounded-full shadow-[0_4px_16px_rgba(0,0,0,0.12)]',
        ...
        >
          ...
          <span className="menu-line block mx-auto rounded-[2px]" style={{ marginTop: '6px', width: 26, height: 2, background: menuContentColor, transform: isMenuOpen ? 'translateY(-4px) rotate(-45deg)' : 'none' }} />
        </button>
      </nav>
